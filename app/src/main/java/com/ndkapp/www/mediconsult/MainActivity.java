        ...
        nav.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch(menuItem.getItemId())
                {
                    ...
                    case R.id.nav_logoutBy:
                        Intent logIn = new Intent(MainActivity.this, login_by.class);
                        startActivity(logIn);
                        break;

                    case R.id.nav_Buy_MedicineBy:
                        Intent inthree = new Intent(MainActivity.this,view_cart_Activity.class);
                        startActivity(inthree);
                        break;

                    case R.id.nav_Find_DoctorBy:
                        Intent infour = new Intent(MainActivity.this, findDoctor.class);
                        startActivity(infour);
                        break;

                    case R.id.nav_Lab_testBy:
                        Intent inlast = new Intent(MainActivity.this, lab_test_Activity.class);
                        startActivity(inlast);
                        break;



                    case R.id.nav_registerBy:
                        Intent register = new Intent(MainActivity.this,show_AllBookings_activity.class);
